<template>
<!-- 	<view class="contain">
	<view class="navbar"><image src="@/static/assets/image/back.png" style='height: 4vh;width: 8vw;position: absolute;left: 2vw;'  mode="" @click="gotoIndex()"></image>气温详情</view>
	</view> -->
	<view class="page">
		<echart class="echarts" :style="{width:'100vw',height:'35vh',}" :option="Options" v-if="destory"></echart>
		<view class="detail">
			<view class="card">
		...
		<view class="tips">* 适宜鳗鱼养殖的气温应在20℃ ~ 30℃</view>
	</view>
</template>
